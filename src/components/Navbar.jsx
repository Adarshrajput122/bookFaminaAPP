...
function Navbar() {
  ...
  return (
    <>
    <div className={` max-w-screen-2xl container mx-auto md:px-20 px-4 fixed dark:bg-slate-900 dark:text-white top-0 left-0 right-0 z-50 ${
  ...
  <div className="navbar-start">
    ...
    <a className="text-2xl font-bold cursor-pointer">Book Famina</a>
  </div>
...
<div className="flex-none ">
    <div className="dropdown dropdown-end ">
      ...
      <div tabIndex={0} className="mt-3 z-[1] card card-compact dropdown-content w-52 bg-base-100 shadow dark:bg-slate-600 dark:text-white">
        <div className="card-body">
          <span className="font-bold text-lg">0 Items</span>
          <span className="text-info">Subtotal: $0</span>
          <div className="card-actions">
            <a className="btn btn-primary btn-block"onClick={()=>document.getElementById("my_modal_3").showModal()}>View cart</a>
          </div>
        </div>
      </div>
    </div>
